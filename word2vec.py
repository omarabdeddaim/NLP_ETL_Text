# -*- coding: utf-8 -*-
"""
Created on Wed Feb 12 15:23:26 2020
...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  7 12:25:23 2020
...
#X,Y=generate_training_data(T, A, 3)
...
def main():
    df = pd.read_csv('DataFinaleCleaning.csv')
    X = df.iloc[:120,18]
    str1 = ''.join(X)
    tokens = tokenize(str1)
    word_to_id, id_to_word = mapping(tokens)
